...
def agregar_pais(paises):
    ...
    try:
        ...
        if nombre == "":
            print("Error: el nombre no puede estar vacío. Por favor, vuelve a intentarlo")
            return paises
        
        poblacion = input("Población: ").strip()
        if poblacion == "":
            print("Error: la población no puede estar vacía. Por favor, vuelve a intentarlo")
            return paises
        poblacion = int(poblacion)
        
        superficie = input("Superficie: ").strip()
        if superficie == "":
            print("Error: la superficie no puede estar vacía. Por favor, vuelve a intentarlo")
            return paises
        superficie = int(superficie)
        
        continente = input("Continente: ").strip()
        if continente == "":
            print("Error: el continente no puede estar vacío. por favor vuelve a intentarlo")
            return paises
        ...
        print("Error: debes ingresar números en población y superficie. Por favor, vuelve a intentarlo")
...
def buscar_pais(paises):
    ...
    nombre = input("Ingresa el nombre del país que deseas buscar: ")
    encontrado = False
...
def filtrar_por_continente(paises):
    ...
    continente = input("Ingresa el continente que deseas filtrar: ")
